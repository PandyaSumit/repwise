...
from repwise.crud import training_plan_crud
from repwise.database.db import get_db
from repwise.models import TrainingPlan
from repwise.models.user import User
from repwise.schemas.common import Page
from repwise.schemas.training_plan import (
    TrainingPlanCreate,
    TrainingPlanInDB,
    TrainingPlanUpdate,
)
from repwise.schemas.training_unit import TrainingUnitInDB
from repwise.services import training_plan as training_plan_service
...
async def get_all_training_plans(
    ...
    items, total = await training_plan_service.list_training_plans(
